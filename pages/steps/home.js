...
export default function BlogHome() {
    ...
    const fetchData = () => {
        if(fetchLoad) {
            onSnapshot(
                query(collection(db, "steps"), orderBy("timestamp", "desc")),
                (snapshot) => {
                                            ...
                                            <li className="mb-3 bg-gray-900 dark:bg-gray-800 rounded-lg">

                                                {
                                                    ...
                                                    (
                                                        ...
                                                        <div className="relative">
                                                            <img className="w-full h-48 rounded-lg object-cover" src={e?.data()?.img ? e?.data()?.img : 'https://propertywiselaunceston.com.au/wp-content/themes/property-wise/images/no-image.png'} />
                                                ...
                                                <div className="p-4 flex gap-4 w-full ">
                                                    <div className="w-full border rounded-lg p-4">
                                                        <p className="text-gray-400">{e?.data()?.AllSteps?.length} Problems Solutions</p>
