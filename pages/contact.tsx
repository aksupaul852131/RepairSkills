    ...
    return (
        <>
            <Head>
                ...
                <link rel="canonical" href="https://repair-skills.com/contact" />

                <meta name="description" content=" If you have any questions, comments, or concerns about RepairSkills, we would love to hear from you. Our team is here to help and is always happy to assist with any inquiries you may have. Please fill out the contact form below, and we will get back to you as soon as possible." />
            </Head>
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p className="text-body-color mb-9 text-base leading-relaxed">
                                    RepairSkills is an Online Community & Technician Learning Platform, Contac for any inquairy
                                </p>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">
                                            (+91) 9060954800 <span>Only Whatsapp</span>
                                        </p>
                                    </div>
                                </div>
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-body-color text-base">repairskills.worldwide@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
