        ...
        <div
            ...
            <div className="mt-6 px-4 md:px-0 w-full flex">
                ...
                <div>
                    <div className="flex">
                        <h4
                            className={`font-bold text-[15px] sm:text-base text-black group-hover:underline inline-block dark:text-white`}
                        >
                            {post?.username}
                        </h4>
                        ...
                        {/* username */}
                        <span
                            className={`text-sm sm:text-[15px] ml-2 dark:text-gray-300`}
                        >
                            @{post?.tag}
                        </span>
                    </div>
            ...
            <div className="flex flex-col space-y-2 w-full">
                ...
                <div className={`text-[#6e767d] dark:text-white flex items-center justify-between py-2 px-4 md:px-0 gap-2`}>
                    ...
                    <div
                        ...
                        className={`w-full justify-center rounded-full px-3 py-2 flex gap-2 ${holdVote == 1 ? `bg-primary text-white` : `bg-gray-100 dark:bg-gray-800`}`}>
                    ...
                    <div
                        ...
                        className={`w-full justify-center rounded-full px-3 py-2 flex gap-2 ${holdVote == 2 ? `bg-primary text-white` : `bg-gray-100 dark:bg-gray-800`}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div
                        ...
                        className="w-full justify-center rounded-full px-3 py-2 bg-gray-100 flex icon group dark:bg-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                </div>
                {
                    session?.user?.name ?
                        ...
                        <p className="text-center text-xs mt-4 dark:text-white">This Reply as <span className="text-primary">{session?.user?.name}</span></p>
                        :
